        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            render={
              <Button
                variant="secondary"
                className="absolute top-surface right-surface"
                size="icon-sm"
              >
                <XIcon />
...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={merge("gap-0.5 p-surface pb-layout flex flex-col", className)}
      {...props}
    />
  );
}
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={merge(
        "gap-2 p-surface pt-layout mt-auto flex flex-col",
        className,
      )}
      {...props}
    />
...
function SheetTitle({ className, ...props }: SheetPrimitive.Title.Props) {
  return (
    <SheetPrimitive.Title
      ...
      className={merge("text-dark-tone text-base font-bold", className)}
      {...props}
    />
  );
}
...
function SheetDescription({
  ...
  return (
    <SheetPrimitive.Description
      ...
      className={merge("text-light-tone-muted text-sm", className)}
      {...props}
    />
  );
}
