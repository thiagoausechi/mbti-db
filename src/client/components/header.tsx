...
const Wrapper = twx.header`sticky top-0 z-50 flex md:pt-8`;
const Content = twx.div`container grid grid-cols-2 items-center rounded-b-2xl p-6 backdrop-blur-lg transition-colors duration-500 md:rounded-2xl`;
